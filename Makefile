...
ifeq ($(PLATFORM),macos)
	...
	@if exist scripts\build-windows.bat ( \
		...
		echo "  sc create SimpleTftpDaemon binPath= \"$(INSTALL_PREFIX)\\bin\\$(PROJECT_NAME).exe\""; \
		echo "  sc start SimpleTftpDaemon"; \
	)
endif
...
help:
	@echo "Simple TFTP Daemon - A lightweight and secure TFTP server - Main Help"
	@echo "=================================="
	@echo ""
...
help-all:
	@echo "Simple TFTP Daemon - A lightweight and secure TFTP server - All Available Targets"
	@echo "=============================================="
	@echo ""
	@echo "Essential targets:"
	@echo "  all              - Build the project (default)"
...
ifeq ($(PLATFORM),macos)
	...
	@sc config SimpleTftpDaemon start= auto
endif
...
ifeq ($(PLATFORM),macos)
	...
	@sc config SimpleTftpDaemon start= disabled
endif
...
ifeq ($(PLATFORM),macos)
	...
	@sc query SimpleTftpDaemon >nul 2>&1 && ( \
		sc stop SimpleTftpDaemon; \
